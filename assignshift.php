...
<body>
    ...
    <div class="page-content p-5" id="content">
        ...
        <div class="row text-white">
            <div class="row text-white">
                <div class="col-lg-3">
                    <button type="button" class="btn btn-white" onclick="showTable('1')">Line</button>
                </div>
                <div class="col-lg-3">
                    <button type="button" class="btn btn-white" onclick="showTable('2')">Dishroom</button>
                </div>
                <div class="col-lg-3">
                    <button type="button" class="btn btn-white" onclick="showTable('3')">Kitchen</button>
                </div>
                <div class="col-lg-3">
                    <button type="button" class="btn btn-white" onclick="showTable('4')">GrabnGo</button>
                </div>
...
<script src="https://cdn.datatables.net/1.13.7/js/jquery.dataTables.js"></script>
    ...
    <script>
        ...
        $('#AssignEmployeebtn').on('click',function(){
            ...
            $.ajax({
                type:'post',
                url:'http://localhost/project-dcsms/api/AssignTaskEmp.php',
                data:{
                    AssignEmp:AssignEmp,
                    schid:schid,
                },
    ...
    $('#myDataTable').DataTable({
        "ajax": {
            "url": 'http://localhost/project-dcsms/api/getassignshift.php',
            "type": "POST",
            "data": function () {
