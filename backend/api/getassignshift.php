...
if (isset($_POST['CatId'])) {
    $cid = $_POST['CatId'];
    $curr_day = date('l');
    $sql = "SELECT schid,day,starttime,endtime,sid,schedule.scid,scname FROM schedule LEFT JOIN subcategory on schedule.scid=subcategory.scid WHERE schedule.cid='$cid' AND schedule.sid is NULL";
